...
// is now general job search). Ranked matches across the operator's book; approve
// queues a placement, decline dismisses.
  ...
  return (
    <div className="mx-auto max-w-5xl px-8 py-8">
      <div className="mb-5 flex items-end justify-between gap-4">
        <div>
          <h1 className="font-heading text-[28px] font-bold tracking-tight text-foreground">Review</h1>
          <p className="text-sm text-muted-foreground">
      ...
      <div className="mb-5">
        <CommandBar onSubmit={(q) => router.push(`/explore?q=${encodeURIComponent(q)}`)} />
      </div>
